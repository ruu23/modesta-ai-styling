...
const partnerBrands = ["ZARA", "MODANISA", "ASOS", "SHEIN", "H&M", "MANGO", "MASSIMO DUTTI", "COS"];
...
const EditorialImage = ({
  ...
  <div className={`relative bg-muted overflow-hidden ${className}`} style={{ aspectRatio: aspect }}>
    ...
    {overlay && <div className="absolute inset-0 bg-background/20" />}
    {children}
  </div>
);
      ...
      <div className="min-h-screen bg-background pb-24">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            {featureCards.map((card, index) => (
              <motion.div key={index} variants={staggerItem}>
                <Link
                  to={
                    card.title === "AI Stylist"
                      ? "/chat"
                      : card.title === "Plan Outfits"
                        ? "/calendar"
                        : card.title === "Shop"
                          ? "/closet"
                          : "/settings"
        ...
        >
          ...
          <div className="overflow-x-auto scrollbar-hide">
            <motion.div className="flex gap-8 md:gap-12 px-6 md:px-12 lg:px-20 pb-2" variants={staggerContainer}>
        ...
        >
          ...
          <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-5" variants={staggerContainer}>
        ...
        >
          ...
          <div className="flex items-center justify-around py-3 px-4 max-w-lg mx-auto">
            {bottomNavItems.map((item, index) => (
              <Link key={index} to={item.to} className="flex flex-col items-center gap-1 px-3 py-1 group">
                <item.icon
